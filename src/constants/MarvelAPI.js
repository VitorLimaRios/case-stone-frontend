...
export const CHARACTER_URL = `${BASE_URL}characters?limit=100&ts=${ts}&apikey=${PUBLIC_KEY}&hash=${hash}`;
export const COMIC_URL = `${BASE_URL}comics?limit=100&ts=${ts}&apikey=${PUBLIC_KEY}&hash=${hash}`;
